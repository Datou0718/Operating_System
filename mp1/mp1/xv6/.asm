...
void s4(int signo)
{
   ...
   e:	f3e50513          	addi	a0,a0,-194 # f48 <thread_kill+0x10>
...
void s3(int signo)
{
  ...
  30:	f2c50513          	addi	a0,a0,-212 # f58 <thread_kill+0x20>
...
0000000000000044 <s5>:
{
  ...
  60:	f0ca8a93          	addi	s5,s5,-244 # f68 <thread_kill+0x30>
        if(i == 8) {
  64:	4a21                	li	s4,8
  ...
  7e:	c78080e7          	jalr	-904(ra) # cf2 <thread_exit>
        thread_yield();
  82:	00001097          	auipc	ra,0x1
  86:	e1e080e7          	jalr	-482(ra) # ea0 <thread_yield>
    while(1) {
...
{   
  ...
  ba:	ec2a0a13          	addi	s4,s4,-318 # f78 <thread_kill+0x40>
        i++;
        if(i == 26) {
  ...
  da:	dca080e7          	jalr	-566(ra) # ea0 <thread_yield>
        if(signo) printf("handler 2: %d\n", i*2);
...
void f2(void *arg)
{
 ...
 118:	e7450513          	addi	a0,a0,-396 # f88 <thread_kill+0x50>
 11c:	00001097          	auipc	ra,0x1
 120:	8de080e7          	jalr	-1826(ra) # 9fa <printf>
 124:	4485                	li	s1,1
 126:	00001a17          	auipc	s4,0x1
 12a:	e62a0a13          	addi	s4,s4,-414 # f88 <thread_kill+0x50>
        if (i == 4) {
 12e:	4991                	li	s3,4
 ...
 138:	d6c080e7          	jalr	-660(ra) # ea0 <thread_yield>
        printf("thread 2: %d\n", i++);
 ...
 154:	ba2080e7          	jalr	-1118(ra) # cf2 <thread_exit>
...
000000000000015a <f5>:
{
 ...
 178:	da8080e7          	jalr	-600(ra) # f1c <thread_register_handler>
        printf("thread 5: %d\n", i++);
 17c:	45a9                	li	a1,10
 17e:	00001517          	auipc	a0,0x1
 182:	e1a50513          	addi	a0,a0,-486 # f98 <thread_kill+0x60>
 186:	00001097          	auipc	ra,0x1
 18a:	874080e7          	jalr	-1932(ra) # 9fa <printf>
 18e:	44ad                	li	s1,11
 190:	00001a17          	auipc	s4,0x1
 194:	e08a0a13          	addi	s4,s4,-504 # f98 <thread_kill+0x60>
        if (i == 17) {
 198:	49c5                	li	s3,17
 ...
 1a2:	d02080e7          	jalr	-766(ra) # ea0 <thread_yield>
        printf("thread 5: %d\n", i++);
 ...
 1be:	b38080e7          	jalr	-1224(ra) # cf2 <thread_exit>
...
00000000000001c4 <f4>:
{
 ...
 212:	c92080e7          	jalr	-878(ra) # ea0 <thread_yield>
        printf("thread 4: %d\n", i++);
 ...
 22e:	ac8080e7          	jalr	-1336(ra) # cf2 <thread_exit>
...
0000000000000234 <f3>:
{
 ...
 258:	cc8080e7          	jalr	-824(ra) # f1c <thread_register_handler>
 ...
 274:	a30080e7          	jalr	-1488(ra) # ca0 <thread_add_runqueue>
 ...
 290:	a14080e7          	jalr	-1516(ra) # ca0 <thread_add_runqueue>
    int i = 10000;
 294:	6589                	lui	a1,0x2
 296:	71058593          	addi	a1,a1,1808 # 2710 <__global_pointer$+0xeff>
        printf("thread 3: %d\n", i++);
 29a:	00001997          	auipc	s3,0x1
 29e:	d1e98993          	addi	s3,s3,-738 # fb8 <thread_kill+0x80>
        if (i == 10003) {
 2a2:	6a89                	lui	s5,0x2
 2a4:	713a8913          	addi	s2,s5,1811 # 2713 <__global_pointer$+0xf02>
        if (i == 10004) {
 ...
 2ba:	c82080e7          	jalr	-894(ra) # f38 <thread_kill>
        if (i == 10006) {
 ...
 2c8:	c74080e7          	jalr	-908(ra) # f38 <thread_kill>
        if (i == 10006) {
 2cc:	a029                	j	2d6 <f3+0xa2>
            thread_exit();
 2ce:	00001097          	auipc	ra,0x1
 2d2:	a24080e7          	jalr	-1500(ra) # cf2 <thread_exit>
        thread_yield();
 2d6:	00001097          	auipc	ra,0x1
 2da:	bca080e7          	jalr	-1078(ra) # ea0 <thread_yield>
        printf("thread 3: %d\n", i++);
 2de:	85a6                	mv	a1,s1
...
void f1(void *arg)
{
 ...
 320:	c00080e7          	jalr	-1024(ra) # f1c <thread_register_handler>
    int i = 100;
 ...
 33c:	968080e7          	jalr	-1688(ra) # ca0 <thread_add_runqueue>
 ...
 358:	94c080e7          	jalr	-1716(ra) # ca0 <thread_add_runqueue>
    int i = 100;
 ...
 364:	c6898993          	addi	s3,s3,-920 # fc8 <thread_kill+0x90>
        if (i == 101) {
 ...
 37e:	bbe080e7          	jalr	-1090(ra) # f38 <thread_kill>
        if (i == 105) {
 ...
 38c:	bb0080e7          	jalr	-1104(ra) # f38 <thread_kill>
        if (i == 105) {
 390:	a029                	j	39a <f1+0x9e>
            thread_exit();
 392:	00001097          	auipc	ra,0x1
 396:	960080e7          	jalr	-1696(ra) # cf2 <thread_exit>
        }
        thread_yield();
 39a:	00001097          	auipc	ra,0x1
 39e:	b06080e7          	jalr	-1274(ra) # ea0 <thread_yield>
        printf("thread 1: %d\n", i++);
 3a2:	85a6                	mv	a1,s1
...
int main(int argc, char **argv)
{
 ...
 3cc:	c1050513          	addi	a0,a0,-1008 # fd8 <thread_kill+0xa0>
 ...
 3ee:	8b6080e7          	jalr	-1866(ra) # ca0 <thread_add_runqueue>
    thread_start_threading();
 3f2:	00001097          	auipc	ra,0x1
 3f6:	afe080e7          	jalr	-1282(ra) # ef0 <thread_start_threading>
    printf("\nexited\n");
 3fa:	00001517          	auipc	a0,0x1
 3fe:	bee50513          	addi	a0,a0,-1042 # fe8 <thread_kill+0xb0>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 76a:	89a50513          	addi	a0,a0,-1894 # 1000 <digits>
 76e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 836:	7ceb8b93          	addi	s7,s7,1998 # 1000 <digits>
 ...
 976:	68690913          	addi	s2,s2,1670 # ff8 <thread_kill+0xc0>
        while(*s != 0){
...
free(void *ap)
{
 ...
 a3e:	5de7b783          	ld	a5,1502(a5) # 1018 <freep>
 ...
 a6c:	00e6ea63          	bltu	a3,a4,a80 <free+0x50>
{
 ...
 aae:	56f73723          	sd	a5,1390(a4) # 1018 <freep>
}
 ab2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 ae0:	53c53503          	ld	a0,1340(a0) # 1018 <freep>
 ...
 b08:	51490913          	addi	s2,s2,1300 # 1018 <freep>
  if(p == (char*)-1)
 b0c:	5afd                	li	s5,-1
 b0e:	a88d                	j	b80 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 b10:	00000797          	auipc	a5,0x0
 b14:	51878793          	addi	a5,a5,1304 # 1028 <base>
 ...
 b42:	4ca73d23          	sd	a0,1242(a4) # 1018 <freep>
      return (void*)(p + 1);
...
struct thread *thread_create(void (*f)(void *), void *arg)
{
 ...
 c26:	14800513          	li	a0,328
 c2a:	00000097          	auipc	ra,0x0
 c2e:	e8e080e7          	jalr	-370(ra) # ab8 <malloc>
 c32:	84aa                	mv	s1,a0
    unsigned long new_stack_p;
    unsigned long new_stack;
    new_stack = (unsigned long)malloc(sizeof(unsigned long) * 0x100);
 c34:	6a05                	lui	s4,0x1
 c36:	800a0513          	addi	a0,s4,-2048 # 800 <vprintf+0x12>
 c3a:	00000097          	auipc	ra,0x0
 c3e:	e7e080e7          	jalr	-386(ra) # ab8 <malloc>
    new_stack_p = new_stack + 0x100 * 8 - 0x2 * 8;
    t->fp = f;
 c42:	0134b023          	sd	s3,0(s1)
    t->arg = arg;
 c46:	0124b423          	sd	s2,8(s1)
    t->ID = id;
 c4a:	00000717          	auipc	a4,0x0
 c4e:	3ca70713          	addi	a4,a4,970 # 1014 <id>
 c52:	431c                	lw	a5,0(a4)
 c54:	08f4aa23          	sw	a5,148(s1)
    t->buf_set = 0;
 c58:	0804a823          	sw	zero,144(s1)
    t->stack = (void *)new_stack;
 c5c:	e888                	sd	a0,16(s1)
    new_stack_p = new_stack + 0x100 * 8 - 0x2 * 8;
 c5e:	7f050513          	addi	a0,a0,2032
    t->stack_p = (void *)new_stack_p;
 c62:	ec88                	sd	a0,24(s1)
    id++;
...
void thread_add_runqueue(struct thread *t)
{
 ...
 caa:	37a7b783          	ld	a5,890(a5) # 1020 <current_thread>
 cae:	cf91                	beqz	a5,cca <thread_add_runqueue+0x2a>
        current_thread = t;
    }
    else
    {
 ...
 cb0:	77d8                	ld	a4,168(a5)
 cb2:	f558                	sd	a4,168(a0)
        t->sig_handler[1] = current_thread->sig_handler[1];
 cb4:	7bd8                	ld	a4,176(a5)
 cb6:	f958                	sd	a4,176(a0)
        t->previous = current_thread->previous;
 cb8:	6fd8                	ld	a4,152(a5)
 cba:	ed58                	sd	a4,152(a0)
        t->next = current_thread;
 cbc:	f15c                	sd	a5,160(a0)
        current_thread->previous->next = t;
 cbe:	6fd8                	ld	a4,152(a5)
 cc0:	f348                	sd	a0,160(a4)
        current_thread->previous = t;
 cc2:	efc8                	sd	a0,152(a5)
    }
    return;
}
 cc4:	6422                	ld	s0,8(sp)
 ...
 cc8:	8082                	ret
        t->previous = t;
 cca:	ed48                	sd	a0,152(a0)
        t->next = t;
 ccc:	f148                	sd	a0,160(a0)
        current_thread = t;
 cce:	00000797          	auipc	a5,0x0
 cd2:	34a7b923          	sd	a0,850(a5) # 1020 <current_thread>
 cd6:	b7fd                	j	cc4 <thread_add_runqueue+0x24>

0000000000000cd8 <schedule>:
    {
...
void schedule(void)
{
 ...
 ce2:	34278793          	addi	a5,a5,834 # 1020 <current_thread>
 ce6:	6398                	ld	a4,0(a5)
 ce8:	7358                	ld	a4,160(a4)
 cea:	e398                	sd	a4,0(a5)
}
 cec:	6422                	ld	s0,8(sp)
...
void thread_exit(void)
{
 ...
 cfc:	00000497          	auipc	s1,0x0
 d00:	3244b483          	ld	s1,804(s1) # 1020 <current_thread>
 d04:	70dc                	ld	a5,160(s1)
 d06:	04f48363          	beq	s1,a5,d4c <thread_exit+0x5a>
    {
        // TODO
        struct thread *to_exit = current_thread;
        current_thread->next->previous = current_thread->previous;
 d0a:	6cd8                	ld	a4,152(s1)
 d0c:	efd8                	sd	a4,152(a5)
        current_thread->previous->next = current_thread->next;
 d0e:	70dc                	ld	a5,160(s1)
 d10:	f35c                	sd	a5,160(a4)
        current_thread = current_thread->next;
 d12:	00000717          	auipc	a4,0x0
 d16:	30f73723          	sd	a5,782(a4) # 1020 <current_thread>
        free(to_exit->stack);
 d1a:	6888                	ld	a0,16(s1)
 d1c:	00000097          	auipc	ra,0x0
 d20:	d14080e7          	jalr	-748(ra) # a30 <free>
        free(to_exit->handler_stack);
 d24:	1384b503          	ld	a0,312(s1)
 d28:	00000097          	auipc	ra,0x0
 d2c:	d08080e7          	jalr	-760(ra) # a30 <free>
        free(to_exit);
 d30:	8526                	mv	a0,s1
 d32:	00000097          	auipc	ra,0x0
 d36:	cfe080e7          	jalr	-770(ra) # a30 <free>
        dispatch();
 d3a:	00000097          	auipc	ra,0x0
 d3e:	054080e7          	jalr	84(ra) # d8e <dispatch>
 ...
 d4c:	6888                	ld	a0,16(s1)
 d4e:	00000097          	auipc	ra,0x0
 d52:	ce2080e7          	jalr	-798(ra) # a30 <free>
        free(current_thread->handler_stack);
 d56:	00000497          	auipc	s1,0x0
 d5a:	2ca48493          	addi	s1,s1,714 # 1020 <current_thread>
 d5e:	609c                	ld	a5,0(s1)
 d60:	1387b503          	ld	a0,312(a5)
 d64:	00000097          	auipc	ra,0x0
 d68:	ccc080e7          	jalr	-820(ra) # a30 <free>
        free(current_thread);
 d6c:	6088                	ld	a0,0(s1)
 d6e:	00000097          	auipc	ra,0x0
 d72:	cc2080e7          	jalr	-830(ra) # a30 <free>
        current_thread = NULL;
 d76:	0004b023          	sd	zero,0(s1)
        longjmp(env_st, 1);
 d7a:	4585                	li	a1,1
 d7c:	00000517          	auipc	a0,0x0
 d80:	2bc50513          	addi	a0,a0,700 # 1038 <env_st>
 d84:	00000097          	auipc	ra,0x0
 d88:	e50080e7          	jalr	-432(ra) # bd4 <longjmp>
}
 d8c:	bf5d                	j	d42 <thread_exit+0x50>

0000000000000d8e <dispatch>:
{
 ...
 d9c:	28873703          	ld	a4,648(a4) # 1020 <current_thread>
 da0:	0b872783          	lw	a5,184(a4)
 da4:	56fd                	li	a3,-1
 da6:	04d78a63          	beq	a5,a3,dfa <dispatch+0x6c>
        if (current_thread->sig_handler[current_thread->signo] == NULL_FUNC)
 daa:	07d1                	addi	a5,a5,20
 dac:	078e                	slli	a5,a5,0x3
 dae:	97ba                	add	a5,a5,a4
 db0:	6798                	ld	a4,8(a5)
 db2:	57fd                	li	a5,-1
 db4:	06f70d63          	beq	a4,a5,e2e <dispatch+0xa0>
        if (current_thread->handler_buf_set == 0)
 db8:	00000517          	auipc	a0,0x0
 dbc:	26853503          	ld	a0,616(a0) # 1020 <current_thread>
 dc0:	13052783          	lw	a5,304(a0)
 dc4:	efc9                	bnez	a5,e5e <dispatch+0xd0>
            if (setjmp(current_thread->handler_env) == 0)
 dc6:	0c050513          	addi	a0,a0,192
 dca:	00000097          	auipc	ra,0x0
 dce:	dd2080e7          	jalr	-558(ra) # b9c <setjmp>
 dd2:	c13d                	beqz	a0,e38 <dispatch+0xaa>
            current_thread->sig_handler[current_thread->signo](current_thread->signo);
 dd4:	00000497          	auipc	s1,0x0
 dd8:	24c48493          	addi	s1,s1,588 # 1020 <current_thread>
 ddc:	609c                	ld	a5,0(s1)
 dde:	0b87a503          	lw	a0,184(a5)
 de2:	01450713          	addi	a4,a0,20
 de6:	070e                	slli	a4,a4,0x3
 ...
 dee:	609c                	ld	a5,0(s1)
 df0:	577d                	li	a4,-1
 df2:	0ae7ac23          	sw	a4,184(a5)
            current_thread->handler_buf_set = 0;
 df6:	1207a823          	sw	zero,304(a5)
    if (current_thread->buf_set == 0)
 dfa:	00000517          	auipc	a0,0x0
 dfe:	22653503          	ld	a0,550(a0) # 1020 <current_thread>
 e02:	09052783          	lw	a5,144(a0)
 e06:	e7c9                	bnez	a5,e90 <dispatch+0x102>
        if (setjmp(current_thread->env) == 0)
 e08:	02050513          	addi	a0,a0,32
 e0c:	00000097          	auipc	ra,0x0
 e10:	d90080e7          	jalr	-624(ra) # b9c <setjmp>
 e14:	cd29                	beqz	a0,e6e <dispatch+0xe0>
        current_thread->fp(current_thread->arg);
 e16:	00000797          	auipc	a5,0x0
 e1a:	20a7b783          	ld	a5,522(a5) # 1020 <current_thread>
 e1e:	6398                	ld	a4,0(a5)
 e20:	6788                	ld	a0,8(a5)
 e22:	9702                	jalr	a4
}
 ...
 e32:	ec4080e7          	jalr	-316(ra) # cf2 <thread_exit>
 e36:	b749                	j	db8 <dispatch+0x2a>
                current_thread->handler_buf_set = 1;
 e38:	00000517          	auipc	a0,0x0
 e3c:	1e853503          	ld	a0,488(a0) # 1020 <current_thread>
 e40:	4785                	li	a5,1
 e42:	12f52823          	sw	a5,304(a0)
                current_thread->handler_env->sp = (long unsigned int)current_thread->handler_stack_p;
 e46:	14053783          	ld	a5,320(a0)
 e4a:	12f53423          	sd	a5,296(a0)
                longjmp(current_thread->handler_env, 1);
 e4e:	4585                	li	a1,1
 e50:	0c050513          	addi	a0,a0,192
 e54:	00000097          	auipc	ra,0x0
 e58:	d80080e7          	jalr	-640(ra) # bd4 <longjmp>
 e5c:	bfa5                	j	dd4 <dispatch+0x46>
            longjmp(current_thread->handler_env, 1);
 e5e:	4585                	li	a1,1
 e60:	0c050513          	addi	a0,a0,192
 e64:	00000097          	auipc	ra,0x0
 e68:	d70080e7          	jalr	-656(ra) # bd4 <longjmp>
 e6c:	b779                	j	dfa <dispatch+0x6c>
            current_thread->buf_set = 1;
 e6e:	00000517          	auipc	a0,0x0
 e72:	1b253503          	ld	a0,434(a0) # 1020 <current_thread>
 e76:	4785                	li	a5,1
 e78:	08f52823          	sw	a5,144(a0)
            current_thread->env->sp = (long unsigned int)current_thread->stack_p;
 e7c:	6d1c                	ld	a5,24(a0)
 e7e:	e55c                	sd	a5,136(a0)
            longjmp(current_thread->env, 1);
 e80:	4585                	li	a1,1
 e82:	02050513          	addi	a0,a0,32
 e86:	00000097          	auipc	ra,0x0
 e8a:	d4e080e7          	jalr	-690(ra) # bd4 <longjmp>
 e8e:	b761                	j	e16 <dispatch+0x88>
        longjmp(current_thread->env, 1);
 e90:	4585                	li	a1,1
 e92:	02050513          	addi	a0,a0,32
 e96:	00000097          	auipc	ra,0x0
 e9a:	d3e080e7          	jalr	-706(ra) # bd4 <longjmp>
}
 e9e:	b759                	j	e24 <dispatch+0x96>

0000000000000ea0 <thread_yield>:
{
 ...
 eac:	17853503          	ld	a0,376(a0) # 1020 <current_thread>
 eb0:	0b852703          	lw	a4,184(a0)
 eb4:	57fd                	li	a5,-1
 eb6:	02f70563          	beq	a4,a5,ee0 <thread_yield+0x40>
        if (setjmp(current_thread->handler_env) != 0)
 eba:	0c050513          	addi	a0,a0,192
 ebe:	00000097          	auipc	ra,0x0
 ec2:	cde080e7          	jalr	-802(ra) # b9c <setjmp>
 ec6:	e909                	bnez	a0,ed8 <thread_yield+0x38>
    schedule();
 ec8:	00000097          	auipc	ra,0x0
 ecc:	e10080e7          	jalr	-496(ra) # cd8 <schedule>
    dispatch();
 ed0:	00000097          	auipc	ra,0x0
 ed4:	ebe080e7          	jalr	-322(ra) # d8e <dispatch>
}
 ed8:	60a2                	ld	ra,8(sp)
 eda:	6402                	ld	s0,0(sp)
 ...
 ede:	8082                	ret
        if (setjmp(current_thread->env) != 0)
 ee0:	02050513          	addi	a0,a0,32
 ee4:	00000097          	auipc	ra,0x0
 ee8:	cb8080e7          	jalr	-840(ra) # b9c <setjmp>
 eec:	dd71                	beqz	a0,ec8 <thread_yield+0x28>
 eee:	b7ed                	j	ed8 <thread_yield+0x38>

0000000000000ef0 <thread_start_threading>:
void thread_start_threading(void)
{
 ...
 efc:	14050513          	addi	a0,a0,320 # 1038 <env_st>
 f00:	00000097          	auipc	ra,0x0
 f04:	c9c080e7          	jalr	-868(ra) # b9c <setjmp>
 f08:	c509                	beqz	a0,f12 <thread_start_threading+0x22>
        dispatch();
}
 f0a:	60a2                	ld	ra,8(sp)
 f0c:	6402                	ld	s0,0(sp)
 f0e:	0141                	addi	sp,sp,16
 f10:	8082                	ret
        dispatch();
 f12:	00000097          	auipc	ra,0x0
 f16:	e7c080e7          	jalr	-388(ra) # d8e <dispatch>
}
 f1a:	bfc5                	j	f0a <thread_start_threading+0x1a>

0000000000000f1c <thread_register_handler>:
...
void thread_register_handler(int signo, void (*handler)(int))
{
 ...
 f22:	0551                	addi	a0,a0,20
 f24:	050e                	slli	a0,a0,0x3
 f26:	00000797          	auipc	a5,0x0
 f2a:	0fa7b783          	ld	a5,250(a5) # 1020 <current_thread>
 f2e:	953e                	add	a0,a0,a5
 f30:	e50c                	sd	a1,8(a0)
}
 f32:	6422                	ld	s0,8(sp)
